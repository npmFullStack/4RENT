...
// User location marker - always green, independent of legend
        ...
        <div className="w-full h-full flex flex-col bg-white relative">
            {isLoadingLocations ? (
                ...
                <>
                    ...
                    {/* --- Legend --- */}
                    {isLegendVisible ? (
                        <div className="absolute top-3 right-3 z-[1000] bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-100 overflow-hidden min-w-[168px]">
                        ...
                        <button
                            ...
                            className="absolute top-3 right-3 z-[1000] bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-100 px-3 py-2 text-xs font-semibold text-gray-600 hover:bg-yellow-50 hover:border-yellow-200 hover:text-yellow-700 transition-all duration-200 flex items-center gap-1.5"
                        >
                    ...
                    {/* --- Property Card Popup (bottom on mobile, top-left on desktop) --- */}
